<%
	String[] sildeName = {	
							"About you", "Income and expenses", "Credit management",
							"Financial goals", "Saving and Investing", "Saving for emergency",
							"Insurance planning", "Retirement planning", "Estate planning",	
						};
%>
