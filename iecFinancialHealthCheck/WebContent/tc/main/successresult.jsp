					...
					<div class = "successresult">
						<div class = "containResult">
								<div class = "result_pics">
									<p>你的理財分析結果</p>
									<div class = "moneypig">
										<img id="img_<%=pageCount %>" src = "../../images/tc/goodpig.png" alt = ""/>
										<img src = "../../images/tc/badpig.png" alt = "" style = "display:none;"/>
										<img src = "../../images/tc/begoodpig.png" alt = "" style = "display:none;"/>
									</div>
								</div>
						...
						<div class = "noresult">
								<!--<img src = "../../images/tc/nextpage_button.png" alt = ""/>-->
								<p>請到下一頁</p>
							</div>
...
<!--
  ...
  function showResult_<%=pageCount %>(text,id){
      ...
      getId("img_"+id).src="../../images/tc/"+str[0];
  ...
  //   alert(itmp);
  	 ...
  	 var itag = jobClick();
     if(str[0]=="goodpig.png"){
       //$("#btn_"+id).removeClass().addClass("greenBtn");
       if(str[1].indexOf("无退休计划") > -1){
      ...
      if(itag == '1_jobType_radio5' || str[1].indexOf("无退休计划") > -1){
  ...
  //		alert(resultUlHtml);
      ...
      getId("img_<%=pageCount %>").src="../../images/tc/"+str[0];
  	}
  }
-->
  </script>					